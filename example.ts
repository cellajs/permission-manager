import { AccessPolicyConfiguration, Context, Product, PermissionManager, Membership, MembershipAdapter, Subject, SubjectAdapter } from './src/PermissionManager';

// Create app structure
const organization = new Context(
    'organization',
    ['admin', 'staff', 'student'],
);

const faculty = new Context(
    'faculty',
    ['admin', 'staff', 'student'],
    new Set([organization]),
);

const course = new Context(
    'course',
    ['admin', 'staff', 'student'],
    new Set([faculty]),
);
